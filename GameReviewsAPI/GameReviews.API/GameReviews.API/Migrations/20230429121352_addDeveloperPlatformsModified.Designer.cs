...
namespace GameReviews.API.Migrations
{
    ...
    [Migration("20230429121352_addDeveloperPlatformsModified")]
    partial class addDeveloperPlatformsModified
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameReviews.API.Entities.IntermediateEntities.GamesDevelopers", b =>
                {
                    ...
                    b.HasOne("GameReviews.API.Entities.Game", "Game")
                        .WithOne("GamesDevelopers")
                        .HasForeignKey("GameReviews.API.Entities.IntermediateEntities.GamesDevelopers", "GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
